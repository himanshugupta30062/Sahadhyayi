            ...
            <CardContent className="px-6 pb-8">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <Mail className="absolute left-3.5 top-3 h-4 w-4 text-slate-500 group-focus-within:text-amber-700 transition-colors" />
                    <Input
                      id="email"
                      name="email"
                      type="email"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <Lock className="absolute left-3.5 top-3 h-4 w-4 text-slate-500 group-focus-within:text-amber-700 transition-colors" />
                    <Input
                      id="password"
                      name="password"
                    ...
                    <button
                      ...
                      className="absolute right-3.5 top-3 text-slate-500 hover:text-slate-900 transition-colors"
                    >
              ...
              <div className="mt-7 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    ...
                    className="w-full h-11 rounded-xl border-slate-300 text-slate-900 hover:bg-amber-50/50 hover:border-amber-400 transition-all"
                  >
                  ...
                  <Button
                    ...
                    className="w-full h-11 rounded-xl border-slate-300 text-slate-900 hover:bg-gray-50 hover:border-slate-400 transition-all"
                  >
              ...
              <div className="mt-7 text-center">
                <p className="text-sm text-slate-700">
                  ...
                  <Link 
                    to="/signup" 
                    className="text-amber-800 hover:text-amber-900 font-semibold transition-colors underline-offset-4 hover:underline"
                  >
                    Sign up here
                  </Link>
                </p>
