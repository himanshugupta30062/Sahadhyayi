...
export const HeroContent: React.FC = () => {
  return (
    <div className="relative z-10 text-center max-w-sm sm:max-w-sm px-4 sm:px-6 py-6 sm:py-8 mx-auto pointer-events-none hero-container">
      ...
      <p className="text-gray-300 text-sm sm:text-sm md:text-lg mb-6 sm:mb-8 leading-relaxed">
      ...
      <Link to="/library" className="pointer-events-auto">
        <button className="group px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 bg-gradient-to-r from-red-500 via-green-500 to-blue-500 text-white rounded-full font-semibold transition-all duration-300 flex items-center justify-center gap-2 sm:gap-2 md:gap-3 shadow-xl mx-auto text-sm sm:text-sm md:text-lg hover:shadow-2xl hover:scale-105 min-w-0">
