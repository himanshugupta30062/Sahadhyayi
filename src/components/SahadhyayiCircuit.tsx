...
// Renders a question bubble with native tooltip and hover handlers
const QuestionBubble: React.FC<{
  ...
  >
    <div
      className={`px-3 py-1 rounded-full bg-gradient-to-br ${gradientClasses[color]} text-white text-sm font-medium whitespace-nowrap shadow-lg transition-transform hover:scale-105`}
    >
      {label}
    </div>
  </div>
