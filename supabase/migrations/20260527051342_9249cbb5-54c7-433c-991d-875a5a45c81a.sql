...
-- Public-readable tables that need anon SELECT (have permissive RLS policies)
GRANT SELECT ON public.books_library TO anon;
GRANT SELECT ON public.authors TO anon;
GRANT SELECT ON public.profiles TO anon;
GRANT SELECT ON public.articles TO anon;
GRANT SELECT ON public.book_ratings TO anon;
GRANT SELECT ON public.book_ratings_agg TO anon;
