...
function brokeredPreviewStorage() {
  ...
  const projectId = onPreviewZone ? ((_a3 = host.match(new RegExp("^(?:id-preview(?:-[a-z0-9]+)?|project)--(" + UUID + ")(?:-dev)?(?=\\.|$)", "i"))) == null ? void 0 : _a3[1]) ?? ((_b = host.match(new RegExp("^(" + UUID + ")(?=[.-])", "i"))) == null ? void 0 : _b[1]) : void 0;
...
// src/integrations/supabase/client.ts
var _a;
var SUPABASE_URL = typeof import.meta !== "undefined" && ((_a = import.meta.env) == null ? void 0 : _a.VITE_SUPABASE_URL) || "https://rknxtatvlzunatpyqxro.supabase.co";
var _a2;
var SUPABASE_PUBLISHABLE_KEY = typeof import.meta !== "undefined" && ((_a2 = import.meta.env) == null ? void 0 : _a2.VITE_SUPABASE_ANON_KEY) || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJrbnh0YXR2bHp1bmF0cHlxeHJvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDk5MzI0MjUsImV4cCI6MjA2NTUwODQyNX0.NXIWEwm8NlvzHnxf55cgdsy1ljX2IbFKQL7OS8xlb-U";
