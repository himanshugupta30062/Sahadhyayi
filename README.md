...
1. In your Supabase project, create (or use) a **public** bucket named `book-covers`.
   Make sure the bucket's permissions allow public reads so images are accessible.
